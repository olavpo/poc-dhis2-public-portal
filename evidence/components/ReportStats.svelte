...
<div class="rep">
	<div class="cell"><span class="lab"><Icon name="school" /> Total schools</span><span class="v">{int(r.expected)}</span></div>
	<div class="cell"><span class="lab"><Icon name="file-circle-check" /> Schools reported</span><span class="v">{int(r.submitted)}</span></div>
	<div class="cell"><span class="lab"><Icon name="gauge-high" /> Reporting rate</span><span class="v">{pct(r.completeness)}</span></div>
</div>
...
<style>
	...
	.lab :global(svg) { color: #1a9c5b; margin-right: 5px; }
